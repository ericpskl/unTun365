...
try:
	...
	if data.status_code == 200:
		...
		cidr2mask['/31'] = " 255.255.255.254"
		cidr2mask['/30'] = " 255.255.255.252"
		cidr2mask['/29'] = " 255.255.255.248"
		cidr2mask['/28'] = " 255.255.255.240"
		cidr2mask['/27'] = " 255.255.255.224"
		cidr2mask['/26'] = " 255.255.255.192"
		cidr2mask['/25'] = " 255.255.255.128"
